  ...
  return (
    <div className="bg-primary relative py-10">
      ...
      <div className="flex items-center justify-center gap-5 px-14 mb-5">
        <img alt="slides" src="./slide1.svg" className={`max-h-[360px]`} />
        <img alt="slides" src="./slide2.svg" className={`max-h-[360px]`} />
      </div>
      <div className="flex items-center justify-center gap-5 px-14">
        <img alt="slides" src="./slide3.svg" className={`max-h-[360px]`} />
        <img alt="slides" src="./slide4.svg" className={`max-h-[360px]`} />
      </div>
    </div>
  );
};
